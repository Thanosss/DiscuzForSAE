...
define('SAE_MEMCACHE', 'saemc://discuz/');
define('SAE_STORAGE_NAME', 'discuzx');
define('SAE_STORAGE', 'saestor://'.SAE_STORAGE_NAME.'/discuz/');
$_config = array();
...
$_config['db']['1']['tablepre'] = 'secbug_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'LqV91A_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'TS1a_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '8e75ffGzkHG6RLaY';
